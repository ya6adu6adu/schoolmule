...
<html>
	<head>
		...
		<script type="text/javascript" src="js/tree_courserooms.js"></script>
		<script type="text/javascript" src="js/form_pupils.js"></script>
		...
		<script type="text/javascript" src="js/grid_assignments.js"></script>
			...
			<div id="page-wrap">
				...
				<div id="main-content">
					<div class="box-caption">
						<div class="expand_btn" id="hide-navigation"></div>
