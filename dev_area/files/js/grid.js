...
schoolmule.controls.grid = function(_options){
	...
	var initGrid = function(){
		...
		dhx.grid.loadXML("php/update.php");
		
		//var combo = dhx.grid.getCombo(0);
		//var combo=new dhtmlXCombo(combo_obj,"alfa2",200);
		//
		//console.log(combo);
		//combo.enableFilteringMode(true);
		//combo.loadXML("php/combo.php");
		
		var myDataProcessor = new dataProcessor("php/update.php");
		...
		dhx.grid.attachEvent("onRowSelect", function(id,ind){
			if(ind==6){
				if(id==1){
					...
					//	if(but_id=="ok"){
							dhx.grid.addRow(id+1,"new,0,0,0,new,new", id);
						//} 
