function dhtmlXCalendarObject(inps, skin) {
	...
	this.skin = (skin != null ? skin : (typeof(dhtmlx) != "undefined" && typeof(dhtmlx.skin) == "string" ? dhtmlx.skin : (this.skinDetect()||"dhx_omega")));
...
dhtmlXCalendarObject.prototype.langData["se"] = {
    dateformat: '%d.%m.%Y',
    monthesFNames: ["January","February","March","April","May","June","July","August","September","October","November","December"],
    monthesSNames: ["Jan","Feb","Mar","Apr","Maj","Jun","Jul","Aug","Sep","Okt","Nov","Dec"],
    daysFNames: ["Söndag","Måndag","Tisdag","Onsdag","Torsdag","Fredag","Lördag"],
    daysSNames: ["Sö","Må","Ti","On","To","Fr","Lö"],
    weekstart: 1,weekname: "v"
}
