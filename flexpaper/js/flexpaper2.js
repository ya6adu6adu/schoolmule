...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    var _SWFFile,_PDFFile,_IMGFiles,_IMGFiles_thumbs="",_JSONFile  = "",_jsDirectory="",_cssDirectory="",_localeDirectory="";_WMode = (config.WMode!=null||config.wmmode!=null?config.wmmode||config.WMode:"direct");
