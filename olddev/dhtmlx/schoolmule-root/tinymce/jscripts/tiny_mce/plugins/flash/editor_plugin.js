...
(function() {
	...
	tinymce.create('tinymce.plugins.flashPlugin', {
		...
		init : function(ed, url) {
			// Register the command so that it can be invoked by using tinyMCE.activeEditor.execCommand('mceflash');
			ed.addCommand('mceflash', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 320 + parseInt(ed.getLang('flash.delta_width', 0)),
					height : 120 + parseInt(ed.getLang('flash.delta_height', 0)),
					inline : 1
				}, {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('flash', n.nodeName == 'IMG');
			});
			*/
		},
