...
<div id="dialog6" title="<?php echo dlang("change_weight_dialog","Change objective weight") ?>" style="display:none">
...
<div id="dialog7" title="Change result" style="display:none">
	...
	<div style="float:left">
		<div class="label"><label>Result unit: <span class="resultUnit"></span>, Max: <span id="max"></span>, Pass: <span id="pass"></span></label></div>
	</div>
	<div style="clear:left"></div>
	<br/>
	<!--<div style="float:left;">
	...
	<div id="main-content">
		...
		<div id="overview-footer">
			...
			<div id="buttons-left" style="left: 8px">
				...
				<a class="button" id="dialog_btn6" title="comment_0037"><?php echo dlang("change_weight_dialog","Change objective weight") ?></a>
