...
!function (e, t) {
    ...
    r(l, [], function () {
                ...
                if (o = o || {}, p = {}, h = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, M = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, L = /[ \t\r\n]+/g, H = /^[ \t\r\n]+$/, v = new n({
                        ...
                        start: function (e, t, n) {
                            ...
                            if (r = S ? l.getElementRule(t) : {}) {
                                ...
                                if (B && M[t] && (B = !1), (r.removeEmpty || r.paddEmpty) && b.isEmpty(O))if (r.paddEmpty)b.empty().append(new e("#text", "3")).value = "\xa0"; else if (!b.attributes.map.name && !b.attributes.map.id)return a = b.parent, T[b.name] ? b.empty().remove() : b.unwrap(), void(b = a);
                                b = b.parent
                            }
                        }
        ...
        return function (r, i) {
            ...
            function a(t) {
                ...
                n = t.screenX - T, r = t.screenY - R, P = n * k[2] + D, O = r * k[3] + L, P = 5 > P ? 5 : P, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && k[2] * k[3] !== 0, o && (W(n) > W(r) ? (O = V(P * H), P = V(O / H)) : (P = V(O / H), O = V(P * H))), C.setStyles(_, {
                    ...
                    left: a - n,
                    top: s - r
                }), M || (i.fire("ObjectResizeStart", {target: w, width: D, height: L}), M = !0)
            }
    ...
    }), r(H, [h, A, D, x, L, u, d], function (e, n, r, i, o, a, s) {
        function l(e, t, i, a) {
            var s = this;
        ...
        var n = e.each;
        return {getCssText: t}
    }), r(O, [h, x, L, M, d, P], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e) {
        ...
        return o = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (n) {
            ...
            return n.on("init", function () {
                ...
                l.typing && s(e)
            }), n.addShortcut("ctrl+z", "", "Undo"), n.addShortcut("ctrl+y,ctrl+shift+z", "", "Redo"), n.on("AddUndo Undo Redo ClearUndos", function (e) {
    ...
    }), r(W, [T, u, d, M, x, h], function (e, n, r, i, o, a) {
        ...
        return function (r) {
            ...
            l(this, {execCommand: v, queryCommandState: y, queryCommandValue: b, addCommands: C}), C({
    ...
    }), r(st, [B, x, _, g, u, d], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e, t) {
                try {
    ...
    }), r(dt, [y, f, C, w, _, R, T, H, O, I, F, z, W, V, b, l, at, E, k, st, u, d, ct, ut], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, E) {
        function N(e, t, i) {
            var o = this, a, s;
        ...
        return e.extend({
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    if (H)for (d = 0; d < H.length; d++)L += H[d]; else L = r;
                    var M = T / L;
